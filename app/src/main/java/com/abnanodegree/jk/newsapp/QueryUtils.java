...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            int totalStories = responseJson.getInt("total");
            if (totalStories == 0) {
                return null;
            }
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // for that earthquake.
         //       JSONObject properties = currentEarthquake.getJSONObject("webTitle");

                // Extract the value for the key called "mag"
                String name = properties.getString("sectionName");
                ...
                News news = new News(title,date,name,url);
